        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 sm:h-20 lg:h-24 flex items-center justify-between gap-4">
          <div className="flex items-center gap-1 sm:gap-3 min-w-0">
            ...
            <button
              ...
              className="md:hidden text-site-text p-3 -ml-2 focus:outline-none focus:ring-2 focus:ring-cta/50 rounded-lg transition-colors active:bg-surface-soft shrink-0"
