...
import { SELF_PAY_RATES } from './selfPayRates';
...
export const providers: Provider[] = [
  {
    ...
    out_of_pocket_rates: { testing_standard: SELF_PAY_RATES.psychologicalEvaluation, testing_dyslexia: SELF_PAY_RATES.psychoeducationalEvaluation, esa_evaluation: '$300', guardianship_evaluation: '$500', disability_evaluation: '$1,000+', adoption_evaluation: '$1,500' },
    ...
    availability_note: 'Self-pay: ~4 weeks · Insurance: ~5 months',
  ...
  },
  {
    ...
    out_of_pocket_rates: { medication_intake: SELF_PAY_RATES.intake, medication_followup: SELF_PAY_RATES.therapy },
  ...
  },
  {
    ...
    out_of_pocket_rates: { testing_standard: SELF_PAY_RATES.psychologicalEvaluation, testing_dyslexia: SELF_PAY_RATES.psychoeducationalEvaluation, therapy: SELF_PAY_RATES.therapy },
    states_served: ['Kentucky'],
    ins: ['Medicaid', 'Aetna', 'UHC Community', 'Humana', 'Passport', 'Cigna', 'Anthem', 'Wellcare'],
    wait_times: { testing_insurance: '5 months', testing_out_of_pocket: '4 weeks', therapy: 'Contact for availability' },
    age_groups: ['Teen (12–17)', 'Adult (18–64)', 'Older Adult (65+)'],
    availability_note: 'Testing self-pay: ~4 weeks',
    availability_status: 'waitlist',
    contact_url: 'https://twilightpsychology.clientsecure.me/contact-widget',
  },
  {
    ...
    out_of_pocket_rates: { therapy: SELF_PAY_RATES.therapy },
    states_served: ['Kentucky', 'Tennessee'],
    ins: ['Medicaid', 'Medicare', 'Aetna', 'UHC Community', 'Humana', 'Passport', 'Cigna', 'Anthem', 'Wellcare'],
    wait_times: { testing_insurance: '5 months', testing_out_of_pocket: '7 weeks', therapy: 'Immediate' },
  ...
  },
  {
    ...
    states_served: ['Kentucky'],
    ins: ['Medicaid', 'Aetna', 'UHC Community', 'Humana', 'Passport', 'Cigna', 'Anthem', 'Wellcare'],
    wait_times: { testing_insurance: '4 months', testing_out_of_pocket: '5 weeks', therapy: '6 weeks' },
    age_groups: ['Adult (18–64)', 'Older Adult (65+)'],
  ...
  },
  {
    ...
    out_of_pocket_rates: { therapy: SELF_PAY_RATES.therapy, testing_standard: SELF_PAY_RATES.psychologicalEvaluation, testing_dyslexia: SELF_PAY_RATES.psychoeducationalEvaluation },
    states_served: ['Kentucky'],
    ins: ['Medicaid', 'Aetna', 'UHC Community', 'Humana', 'Passport', 'Cigna', 'Anthem', 'Wellcare'],
    wait_times: { therapy: '2 months', testing_insurance: '3 months', testing_out_of_pocket: '3 weeks' },
    age_groups: ['Child (3–11)', 'Teen (12–17)', 'Adult (18–64)'],
    availability_note: 'Therapy: 2 months',
    availability_status: 'waitlist',
    contact_url: 'https://twilightpsychology.clientsecure.me/contact-widget',
  },
  {
  ...
  },
  {
    ...
    out_of_pocket_rates: { testing_standard: SELF_PAY_RATES.psychologicalEvaluation, therapy: SELF_PAY_RATES.therapy },
    states_served: ['Kentucky'],
    ins: ['Medicaid', 'Aetna', 'UHC Community', 'Humana', 'Passport', 'Cigna', 'Anthem', 'Wellcare'],
  ...
  },
  {
    ...
    out_of_pocket_rates: { therapy: '$125', testing_standard: SELF_PAY_RATES.psychologicalEvaluation },
    states_served: ['Kentucky'],
    ins: ['Medicaid', 'Aetna', 'UHC Community', 'Humana', 'Passport', 'Cigna', 'Anthem', 'Wellcare'],
    wait_times: { therapy: '3 months', testing_insurance: '3 months', testing_out_of_pocket: '3 weeks' },
    age_groups: ['Teen (12–17)', 'Adult (18–64)', 'Older Adult (65+)'],
    availability_note: 'Therapy: 3 months',
    availability_status: 'waitlist',
    contact_url: 'https://twilightpsychology.clientsecure.me/contact-widget',
  },
];
